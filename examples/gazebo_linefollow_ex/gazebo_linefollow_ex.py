...
if __name__ == '__main__':
    ...
    for x in range(total_episodes):
        ...
        i = -1
        while True:  # as long as the line is in the image we follow these instructions below
            i += 1
        ...
        if highest_reward < cumulated_reward:
            ...
            # we need to save the highest QValues
            qlearn.saveQ("best_qvalues")  # This saves the best policy so far
            print("Saved best Q-values with reward: {}".format(highest_reward))
